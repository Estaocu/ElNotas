...
#warning "This version of Stylized Water 2 is strictly compatible with Unity 6.4 or newer. Unity has deprecated the (now) old rendering framework and has migrated to the Render Graph API. Please upgrade to Stylized Water 3, a migration utility will be included."
#endif
...
namespace StylizedWater2
{
    public class AssetInfo
    {
        ...
        public const string INSTALLED_VERSION = "1.7.1";
