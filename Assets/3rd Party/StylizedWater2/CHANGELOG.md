1.7.1
As of May 2026 the asset store no longer allows uploads for Unity 2021.3, though this asset is still compatible with it.

Fixed:
- Critical script compile errors in Unity 6.4+, preventing migration to Stylized Water 3.
